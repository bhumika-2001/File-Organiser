(function(){
    ...
    {
        let divInsideTemplates = templates.content.querySelector(".album");
        let divCopy = document.importNode(divInsideTemplates,true);
        let divName = divCopy.querySelector("[purpose=name");
        let spanEdit = divCopy.querySelector("[action=edit");
        let spanDelete = divCopy.querySelector("[action=delete");
        let spanView = divCopy.querySelector("[action=view");
        spanEdit.addEventListener("click",editAlbum);
    ...
    function viewAlbum(){
        ...
        let divNotepadAlbumTemplate = templates.content.querySelector("[purpose=album-body]");
        let divAlbumBody = document.importNode(divNotepadAlbumTemplate,true); 
        divAppMenuBar.innerHTML = "";
        ...
        spanAdd.addEventListener("click",addPictureToHTML);
    }
